...
This is the project boot sequence for **uk_policy_simulator**. It works for all vendors (Claude, Codex/Flux, Gemini, etc.) without vendor-specific logic.
...
```
uk_policy_simulator boot complete.
